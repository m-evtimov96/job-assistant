...
from job_assistant.crawlers.scraper.scraper import settings
...
class Scraper:
    def __init__(self):
        breakpoint()
        # settings_file_path = 'job_assistant.crawlers.scraper.scraper.settings' # The path seen from root, ie. from main.py
